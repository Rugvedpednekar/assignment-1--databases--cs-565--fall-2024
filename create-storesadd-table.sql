...
(
    store_id       VARCHAR(64)   NOT NULL,     -- Most spice names will fit within a 64-character column.
    store_name     VARCHAR(64)   NOT NULL,
    url_address    VARCHAR(255) NOT NULL,     -- For example, 20.125.
...
INSERT INTO store_addresses (store_id, store_name, url_address, physical_address) VALUES
